...
export async function fetchJiraData() {
  ...
  try {
    ...
    return {
      ...
      burnRateTrend: previousMonthBurnRate > 0 ? ((parseFloat(burnRate) - parseFloat(previousMonthBurnRate)) / parseFloat(previousMonthBurnRate) * 100).toFixed(1) : 0,
      avgResolutionDays: parseFloat(avgAvgResolutionDays.toFixed(2)),
      avgResolutionDaysTrend: previousMonthAvgResolutionDays > 0 ? ((parseFloat(avgAvgResolutionDays) - parseFloat(previousMonthAvgResolutionDays)) / parseFloat(previousMonthAvgResolutionDays) * 100).toFixed(1) : 0,
