...
export async function fetchJiraData() {
  ...
  try {
    ...
    return {
      ...
      avgResolutionDays: parseFloat(avgResolutionDays.toFixed(2)),
      avgResolutionDaysTrend: previousMonthAvgResolutionDays > 0 ? ((parseFloat(avgResolutionDays) - parseFloat(previousMonthAvgResolutionDays)) / parseFloat(previousMonthAvgResolutionDays) * 100).toFixed(1) : 0,
